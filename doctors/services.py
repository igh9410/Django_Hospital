...
def search_doctors_by_string(query):
    ...
    for term in query_terms:
        ...
        term_query = Q(name__icontains=term) | Q(specialties__name__icontains=term) | Q(hospital__icontains=term) | Q(non_reimbursements__name__icontains=term) # Search doctor by name, specialty, hospital, and non-reimbursement
